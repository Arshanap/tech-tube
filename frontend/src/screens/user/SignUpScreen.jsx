...
const SignUpScreen = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#303036" }} // page background
    >
      <div className="bg-black p-8 rounded-xl shadow-2xl w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <button
              ...
              style={{ backgroundColor: '#8F00FF' }} // Solvent Violet 13
              disabled={loading}
            >
              {loading ? (
                <svg
        ...
        <div className="mt-6 space-y-4">
          <button
            className="w-full flex items-center justify-center py-3 px-4 rounded-lg text-white font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition duration-200"
            style={{ backgroundColor: '#8F00FF' }} // violet to match login page styling
